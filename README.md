...
Repository coding standards are maintained in the [Copilot instructions](.github/copilot-instructions.md) and scoped guidance in [.github/instructions](.github/instructions/). These documents define the comment philosophy, TSDoc expectations for data-layer exports, Astro component prop contracts, and TypeScript formatting enforced by ESLint.
